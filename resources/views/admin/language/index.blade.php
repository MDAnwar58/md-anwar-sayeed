                    ...
                    <tbody>
                        @foreach ($languages as $language)
                            <tr>
                                ...
                                <td>{{ $language->name }}</td>
                                <td>
                                    <a href="{{ route('admin.language.edit', $language->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                    <a href="{{ route('admin.language.destroy', $language->id) }}" class="btn btn-danger btn-sm">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
